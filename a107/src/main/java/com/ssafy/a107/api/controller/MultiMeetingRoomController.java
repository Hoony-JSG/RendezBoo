...
public class MultiMeetingRoomController {
    ...
    @PostMapping("/")
    public ResponseEntity<?> makeMultiRoom(MultiMeetingRoomReq multiMeetingRoomReq) throws NotFoundException, OpenViduJavaClientException, OpenViduHttpException {
